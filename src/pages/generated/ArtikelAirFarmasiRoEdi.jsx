...
.art-hero-img{height:320px;background:linear-gradient(135deg,#0d3a6b,#0d5fa8);border-radius:12px;display:flex;align-items:center;justify-content:center;font-size:8rem;margin-bottom:2rem}
...
<div className="bg-gradient-to-r from-blue to-sky py-[3.2rem] text-center text-white">
  <div className="max-w-[1240px] mx-auto px-6">
    <h2 className="font-condensed text-[clamp(1.6rem,2.6vw,2.2rem)] font-extrabold leading-[1.15] mb-[0.65rem]">Siap Implementasi Sistem Air Farmasi?</h2>
    <p className="text-[0.88rem] opacity-90 leading-[1.75] max-w-[600px] mx-auto mb-8">Tim engineer kami siap membantu desain dan implementasi sistem RO + EDI yang memenuhi CPOB dan farmakope internasional.</p>
    <div className="flex gap-4 justify-center flex-wrap">
      <Button variant="white" to="/kontak" >📞 Hubungi Kami</Button>
      <Button variant="outline-white" to="/produk/demi" >🔍 Lihat Produk EDI</Button>
    </div>
  </div>
</div>
