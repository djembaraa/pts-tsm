...
import { ArrowRight, Calculator, Droplet, Waves, Microscope, Ship } from 'lucide-react';
...
<div className="bg-gradient-to-r from-blue to-sky py-[3.2rem] text-center text-white">
  <div className="max-w-[1240px] mx-auto px-6">
    <h2 className="font-condensed text-[clamp(1.6rem,2.6vw,2.2rem)] font-extrabold leading-[1.15] mb-[0.65rem]">Butuh Mesin Suling Air Laut untuk Lokasi Anda?</h2>
    <p className="text-[0.88rem] opacity-90 leading-[1.75] max-w-[600px] mx-auto mb-8">TSM merancang mesin suling air laut dari kapasitas 1 hingga 1.000 m³/hari — kompak untuk kapal dan pulau, bertenaga untuk kawasan industri. Konsultasi gratis bersama engineer kami hari ini.</p>
    <div className="flex gap-4 justify-center flex-wrap">
      <Button variant="white" to="/kontak" >📋 Konsultasi Gratis</Button>
      <Button variant="outline-white" to="/produk/swro" >🔬 Lihat Spesifikasi SWRO</Button>
    </div>
  </div>
</div>
