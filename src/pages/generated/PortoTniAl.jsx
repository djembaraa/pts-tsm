...
<div className="bg-gradient-to-r from-blue to-sky py-[3.2rem] text-center text-white">
  <div className="max-w-[1240px] mx-auto px-6">
    <h2 className="font-condensed text-[clamp(1.6rem,2.6vw,2.2rem)] font-extrabold leading-[1.15] mb-[0.65rem]">Butuh Watermaker untuk Kapal atau Pangkalan?</h2>
    <p className="text-[0.88rem] opacity-90 leading-[1.75] max-w-[600px] mx-auto mb-8">Tim TSM siap membantu spesifikasi, pengadaan, instalasi, hingga commissioning sesuai standar BKI/TNI.</p>
    <div className="flex gap-4 justify-center flex-wrap">
      <Button variant="white" to="/kontak" >📞 Konsultasi Teknis</Button>
      <Button variant="outline-white" to="/produk/fresh-water-generator" >🛠️ Spesifikasi FWG</Button>
    </div>
  </div>
</div>
