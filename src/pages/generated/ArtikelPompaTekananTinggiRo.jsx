...
<div className="bg-gradient-to-r from-blue to-sky py-[3.2rem] text-center text-white">
  <div className="max-w-[1240px] mx-auto px-6">
    <h2 className="font-condensed text-[clamp(1.6rem,2.6vw,2.2rem)] font-extrabold leading-[1.15] mb-[0.65rem]">Butuh Pompa RO Tier-1 untuk Sistem Anda?</h2>
    ...
    <div className="flex gap-4 justify-center flex-wrap">
      ...
      <Button variant="outline-white" to="/produk/pompa" >🔍 Lihat Stok Pompa</Button>
    </div>
  </div>
</div>
