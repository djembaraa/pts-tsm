...
import { ArrowRight, Calculator, Settings, Waves } from 'lucide-react';
...
<div className="bg-gradient-to-r from-blue to-sky py-[3.2rem] text-center text-white">
  <div className="max-w-[1240px] mx-auto px-6">
    <h2 className="font-condensed text-[clamp(1.6rem,2.6vw,2.2rem)] font-extrabold leading-[1.15] mb-[0.65rem]">Air Sumur Anda Asin atau TDS-nya Terlalu Tinggi?</h2>
    <p className="text-[0.88rem] opacity-90 leading-[1.75] max-w-[600px] mx-auto mb-8">Kami siap menganalisis air baku Anda secara gratis dan merancang sistem BWRO yang paling efisien — agar Anda mendapatkan air bersih berkualitas dengan biaya operasional serendah mungkin.</p>
    <div className="flex gap-4 justify-center flex-wrap"><Button variant="white" to="/kontak" >📋 Minta Analisis Air Gratis</Button><Button variant="outline-white" to="/artikel/perbedaan-swro-bwro-twro" >📖 Baca Panduan BWRO vs SWRO</Button></div>
  </div>
</div>
