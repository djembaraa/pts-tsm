...
import { ArrowRight, Factory, Calculator, Droplet } from 'lucide-react';
...
<div className="bg-gradient-to-r from-blue to-sky py-[3.2rem] text-center text-white">
  <div className="max-w-[1240px] mx-auto px-6">
    <h2 className="font-condensed text-[clamp(1.6rem,2.6vw,2.2rem)] font-extrabold leading-[1.15] mb-[0.65rem]">Pastikan Pre-Treatment Anda Melindungi Membran RO</h2>
    <p className="text-[0.88rem] opacity-90 leading-[1.75] max-w-[600px] mx-auto mb-8">Tim engineer TSM siap menganalisis air baku Anda dan merancang sistem filter yang tepat — agar membran RO tahan lama dan biaya operasional minimal.</p>
    <div className="flex gap-4 justify-center flex-wrap"><Button variant="white" to="/kontak" >📋 Minta Penawaran Water Filter</Button><Button variant="outline-white" to="/layanan/audit" >🔍 Audit Sistem Anda</Button></div>
  </div>
</div>
