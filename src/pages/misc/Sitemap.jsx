...
<div className="page-hero bg-gradient-to-br from-navy to-blue text-white py-[3rem] pb-[2.5rem] relative overflow-hidden">
  <div className="container max-w-[1240px] mx-auto px-6">
    <div className="breadcrumb text-[0.72rem] opacity-55 mb-[0.65rem] flex items-center gap-[0.42rem] flex-wrap"><Link to="/index">Beranda</Link> › Peta Situs</div>
    <h1 className="font-condensed text-[clamp(1.6rem,3vw,2.4rem)] font-extrabold leading-[1.1] mb-[0.65rem]">Peta Situs</h1>
    <p className="text-[0.9rem] opacity-80 max-w-[540px] leading-[1.72]">Navigasi lengkap ke seluruh halaman website PT Tirta Sumber Makmur. Temukan dengan cepat informasi yang Anda butuhkan.</p>
  </div>
</div>
