...
<div className="page-hero bg-gradient-to-br from-navy to-blue text-white py-[3rem] pb-[2.5rem] relative overflow-hidden">
  <div className="container max-w-[1240px] mx-auto px-6">
    <div className="breadcrumb text-[0.72rem] opacity-55 mb-[0.65rem] flex items-center gap-[0.42rem] flex-wrap"><Link to="/index">Beranda</Link> › Syarat &amp; Ketentuan</div>
    <h1 className="font-condensed text-[clamp(1.6rem,3vw,2.4rem)] font-extrabold leading-[1.1] mb-[0.65rem]">Syarat &amp; Ketentuan</h1>
    <p className="text-[0.9rem] opacity-80 max-w-[540px] leading-[1.72]">Ketentuan yang mengatur penggunaan website dan layanan PT Tirta Sumber Makmur oleh pengunjung dan klien kami.</p>
  </div>
</div>
...
<div className="cta-band bg-gradient-to-r from-blue to-sky py-[3.2rem] text-center text-white">
  <div className="container max-w-[1240px] mx-auto px-6">
    <h2 className="font-condensed text-[clamp(1.6rem,2.6vw,2.2rem)] font-extrabold leading-[1.15] mb-[0.65rem]">Siap Memulai Proyek Anda?</h2>
    <p className="text-[0.88rem] opacity-90 leading-[1.75] max-w-[600px] mx-auto mb-8">Hubungi tim kami untuk konsultasi dan penawaran proyek water treatment Anda.</p>
    <div className="cta-actions flex gap-4 justify-center flex-wrap">
      <Button variant="white" to="/kontak" >📞 Hubungi Kami</Button>
      <Button variant="outline-white" to="/kebijakan/privasi" >🔒 Lihat Kebijakan Privasi</Button>
    </div>
  </div>
</div>
