...
<div className="page-hero bg-gradient-to-br from-navy to-blue text-white py-[3rem] pb-[2.5rem] relative overflow-hidden">
  <div className="container max-w-[1240px] mx-auto px-6">
    <div className="breadcrumb text-[0.72rem] opacity-55 mb-[0.65rem] flex items-center gap-[0.42rem] flex-wrap"><Link to="/index">Beranda</Link> › Kebijakan Privasi</div>
    <h1 className="font-condensed text-[clamp(1.6rem,3vw,2.4rem)] font-extrabold leading-[1.1] mb-[0.65rem]">Kebijakan Privasi</h1>
    <p className="text-[0.9rem] opacity-80 max-w-[540px] leading-[1.72]">Komitmen kami untuk melindungi privasi dan data pribadi Anda saat menggunakan layanan dan website PT Tirta Sumber Makmur.</p>
  </div>
</div>
<section className="section py-16">
  <div className="container max-w-[1240px] mx-auto px-6">
    <div className="legal-wrap">
      <div className="prose prose max-w-none text-text">
...
<div className="cta-band bg-gradient-to-r from-blue to-sky py-[3.2rem] text-center text-white">
  <div className="container max-w-[1240px] mx-auto px-6">
    <h2 className="font-condensed text-[clamp(1.6rem,2.6vw,2.2rem)] font-extrabold leading-[1.15] mb-[0.65rem]">Ada Pertanyaan Lebih Lanjut?</h2>
    <p className="text-[0.88rem] opacity-90 leading-[1.75] max-w-[600px] mx-auto mb-8">Tim kami siap membantu menjawab pertanyaan Anda terkait privasi dan penanganan data.</p>
    <div className="cta-actions flex gap-4 justify-center flex-wrap">
      <Button variant="white" to="/kontak" >📞 Hubungi Kami</Button>
      <Button variant="outline-white" to="/syarat/ketentuan" >📄 Lihat Syarat &amp; Ketentuan</Button>
    </div>
  </div>
</div>
