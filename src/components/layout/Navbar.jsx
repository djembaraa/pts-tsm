          ...
          <ul className="hidden lg:flex items-stretch h-full">
              ...
              <div className="hidden group-hover:flex absolute top-full left-1/2 -translate-x-[45%] bg-white border border-border border-t-[3px] border-t-blue shadow-[0_18px_56px_rgba(10,34,64,0.18)] rounded-b-[10px] w-max min-w-[980px] p-[2rem] gap-[2.5rem] z-[9999] animate-in fade-in slide-in-from-top-2 duration-200">
                <div className="flex-1 min-w-0">
                  ...
                  <ul className="flex flex-col gap-3">
                    <li><Link to="/produk/ro-industri" className="text-[0.85rem] font-medium text-text flex items-center gap-[0.6rem] hover:text-blue hover:pl-[0.25rem] transition-all">💧 Tap Water RO</Link></li>
                    <li><Link to="/produk/bwro" className="text-[0.85rem] font-medium text-text flex items-center gap-[0.6rem] hover:text-blue hover:pl-[0.25rem] transition-all">💧 Brackish Water RO</Link></li>
                    <li><Link to="/produk/desalinasi" className="text-[0.85rem] font-medium text-text flex items-center gap-[0.6rem] hover:text-blue hover:pl-[0.25rem] transition-all">🌊 Seawater RO</Link></li>
                    <li><Link to="/produk/fresh-water-generator" className="text-[0.85rem] font-medium text-text flex items-center gap-[0.6rem] hover:text-blue hover:pl-[0.25rem] transition-all">🚢 Fresh Water Generator</Link></li>
                    <li><Link to="/produk/ro-mobile" className="text-[0.85rem] font-medium text-text flex items-center gap-[0.6rem] hover:text-blue hover:pl-[0.25rem] transition-all">🚗 Water Maker</Link></li>
                  </ul>
                </div>
                <div className="flex-1 min-w-0">
                  ...
                  <ul className="flex flex-col gap-3">
                    <li><Link to="/produk/sand-filter" className="text-[0.85rem] font-medium text-text flex items-center gap-[0.6rem] hover:text-blue hover:pl-[0.25rem] transition-all">🔵 Sand Filter</Link></li>
                    <li><Link to="/produk/carbon-filter" className="text-[0.85rem] font-medium text-text flex items-center gap-[0.6rem] hover:text-blue hover:pl-[0.25rem] transition-all">⚫ Activated Carbon Filter</Link></li>
                    <li><Link to="/produk/softener" className="text-[0.85rem] font-medium text-text flex items-center gap-[0.6rem] hover:text-blue hover:pl-[0.25rem] transition-all">💧 Softener Filter</Link></li>
                    <li><Link to="/produk/limbah" className="text-[0.85rem] font-medium text-text flex items-center gap-[0.6rem] hover:text-blue hover:pl-[0.25rem] transition-all">🏭 Wastewater Treatment</Link></li>
                    <li><Link to="/produk/demi" className="text-[0.85rem] font-medium text-text flex items-center gap-[0.6rem] hover:text-blue hover:pl-[0.25rem] transition-all">⚗️ Demineralisasi System</Link></li>
                    <li><Link to="/produk/uf" className="text-[0.85rem] font-medium text-text flex items-center gap-[0.6rem] hover:text-blue hover:pl-[0.25rem] transition-all">🔩 Ultrafiltration System</Link></li>
                    <li><Link to="/produk/water-filter" className="text-[0.85rem] font-medium text-text flex items-center gap-[0.6rem] hover:text-blue hover:pl-[0.25rem] transition-all">🔵 Water Filter</Link></li>
                    <li><Link to="/produk/bwms" className="text-[0.85rem] font-medium text-text flex items-center gap-[0.6rem] hover:text-blue hover:pl-[0.25rem] transition-all">⚓ Ballast Water Management</Link></li>
                  </ul>
                </div>
                <div className="flex-1 min-w-0">
                  ...
                  <ul className="flex flex-col gap-3">
                    <li><Link to="/produk/membran" className="text-[0.85rem] font-medium text-text flex items-center gap-[0.6rem] hover:text-blue hover:pl-[0.25rem] transition-all">🧪 Membrane RO</Link></li>
                    <li><Link to="/produk/membran" className="text-[0.85rem] font-medium text-text flex items-center gap-[0.6rem] hover:text-blue hover:pl-[0.25rem] transition-all">🔩 Housing Membrane RO</Link></li>
                    ...
                    <li><Link to="/produk/frp-tank" className="text-[0.85rem] font-medium text-text flex items-center gap-[0.6rem] hover:text-blue hover:pl-[0.25rem] transition-all">🪣 FRP Tank (Tabung Filter)</Link></li>
                    <li><Link to="/produk/zincalume-tank" className="text-[0.85rem] font-medium text-text flex items-center gap-[0.6rem] hover:text-blue hover:pl-[0.25rem] transition-all">🗂️ Stainless Steel Tank</Link></li>
                    <li><Link to="/produk/instrumen" className="text-[0.85rem] font-medium text-text flex items-center gap-[0.6rem] hover:text-blue hover:pl-[0.25rem] transition-all">📊 Media Filter</Link></li>
                    <li><Link to="/produk/uv" className="text-[0.85rem] font-medium text-text flex items-center gap-[0.6rem] hover:text-blue hover:pl-[0.25rem] transition-all">💡 UV Water Sterilizer</Link></li>
                    <li><Link to="/produk/pompa" className="text-[0.85rem] font-medium text-text flex items-center gap-[0.6rem] hover:text-blue hover:pl-[0.25rem] transition-all">⚙️ Multistage Pump</Link></li>
                  </ul>
                </div>
            ...
            <li className="relative flex items-center group">
              ...
              <div className="hidden group-hover:flex absolute top-full left-1/2 -translate-x-[40%] bg-white border border-border border-t-[3px] border-t-blue shadow-[0_18px_56px_rgba(10,34,64,0.18)] rounded-b-[10px] w-max min-w-[780px] p-[2rem] gap-[2.5rem] z-[9999] animate-in fade-in slide-in-from-top-2 duration-200">
                <div className="flex-1 min-w-0">
                  ...
                  <ul className="flex flex-col gap-3">
                    <li><Link to="/layanan/desain" className="text-[0.85rem] font-medium text-text flex items-center gap-[0.6rem] hover:text-blue hover:pl-[0.25rem] transition-all">📐 Desain &amp; Perancangan Sistem</Link></li>
                    <li><Link to="/layanan/instalasi" className="text-[0.85rem] font-medium text-text flex items-center gap-[0.6rem] hover:text-blue hover:pl-[0.25rem] transition-all">🔧 Instalasi &amp; Komisioning</Link></li>
                    <li><Link to="/layanan/maintenance" className="text-[0.85rem] font-medium text-text flex items-center gap-[0.6rem] hover:text-blue hover:pl-[0.25rem] transition-all">🛡️ Pemeliharaan Preventif</Link></li>
                    <li><Link to="/layanan/darurat" className="text-[0.85rem] font-medium text-text flex items-center gap-[0.6rem] hover:text-blue hover:pl-[0.25rem] transition-all">🚨 Servis Darurat 24/7</Link></li>
                  </ul>
                </div>
                <div className="flex-1 min-w-0">
                  ...
                  <ul className="flex flex-col gap-3">
                    <li><Link to="/layanan/audit" className="text-[0.85rem] font-medium text-text flex items-center gap-[0.6rem] hover:text-blue hover:pl-[0.25rem] transition-all">📋 Audit Kualitas Air</Link></li>
                    <li><Link to="/kalkulator" className="text-[0.85rem] font-medium text-text flex items-center gap-[0.6rem] hover:text-blue hover:pl-[0.25rem] transition-all">🧮 Kalkulator Kebutuhan Air</Link></li>
                    <li><Link to="/layanan/feasibility" className="text-[0.85rem] font-medium text-text flex items-center gap-[0.6rem] hover:text-blue hover:pl-[0.25rem] transition-all">📊 Studi Kelayakan</Link></li>
                    <li><Link to="/layanan/epc" className="text-[0.85rem] font-medium text-text flex items-center gap-[0.6rem] hover:text-blue hover:pl-[0.25rem] transition-all">🏗️ Turnkey EPC Project</Link></li>
                    <li><Link to="/layanan/sertifikasi" className="text-[0.85rem] font-medium text-text flex items-center gap-[0.6rem] hover:text-blue hover:pl-[0.25rem] transition-all">📜 Sertifikasi &amp; Compliance</Link></li>
                  </ul>
                </div>
                <div className="flex-[0_0_240px] bg-gradient-to-br from-navy to-blue rounded-[8px] p-[1.5rem] text-white flex flex-col justify-end shadow-inner relative overflow-hidden group/feat">
                  <div className="absolute top-0 left-0 w-full h-[3px] bg-accent"></div>
            ...
            <li className="relative flex items-center group">
              ...
              <div className="hidden group-hover:flex flex-col absolute top-full left-0 bg-white border border-border border-t-[3px] border-t-blue shadow-[0_18px_56px_rgba(10,34,64,0.18)] min-w-[280px] rounded-b-[10px] z-[9999] animate-in fade-in slide-in-from-top-2 duration-200 py-[0.8rem]">
                <Link to="/industri/manufaktur" className="px-[1.5rem] py-[0.6rem] text-[0.85rem] font-medium text-text flex items-center gap-[0.6rem] hover:bg-ice hover:text-blue hover:pl-[1.8rem] transition-all">🏭 Industri Manufaktur</Link>
                ...
                <Link to="/industri/properti" className="px-[1.5rem] py-[0.6rem] text-[0.85rem] font-medium text-text flex items-center gap-[0.6rem] hover:bg-ice hover:text-blue hover:pl-[1.8rem] transition-all">🏗️ Properti &amp; Apartemen</Link>
                <Link to="/industri/maritim" className="px-[1.5rem] py-[0.6rem] text-[0.85rem] font-medium text-text flex items-center gap-[0.6rem] hover:bg-ice hover:text-blue hover:pl-[1.8rem] transition-all">🚢 Maritim &amp; Offshore</Link>
              </div>
            </li>
            ...
            <li className="relative flex items-center group">
              ...
              <div className="hidden group-hover:flex flex-col absolute top-full left-0 bg-white border border-border border-t-[3px] border-t-blue shadow-[0_18px_56px_rgba(10,34,64,0.18)] min-w-[260px] rounded-b-[10px] z-[9999] animate-in fade-in slide-in-from-top-2 duration-200 py-[0.8rem]">
                ...
                <Link to="/tentang#sertifikasi" className="px-[1.5rem] py-[0.6rem] text-[0.85rem] font-medium text-text flex items-center gap-[0.6rem] hover:bg-ice hover:text-blue hover:pl-[1.8rem] transition-all">📜 Sertifikasi &amp; Penghargaan</Link>
            ...
            <li className="relative flex items-center group">
              ...
              <div className="hidden group-hover:flex flex-col absolute top-full left-0 bg-white border border-border border-t-[3px] border-t-blue shadow-[0_18px_56px_rgba(10,34,64,0.18)] min-w-[260px] rounded-b-[10px] z-[9999] animate-in fade-in slide-in-from-top-2 duration-200 py-[0.8rem]">
                ...
                <Link to="/artikel#desalinasi" className="px-[1.5rem] py-[0.6rem] text-[0.85rem] font-medium text-text flex items-center gap-[0.6rem] hover:bg-ice hover:text-blue hover:pl-[1.8rem] transition-all">🌊 Artikel Desalinasi</Link>
                <Link to="/artikel#perawatan" className="px-[1.5rem] py-[0.6rem] text-[0.85rem] font-medium text-text flex items-center gap-[0.6rem] hover:bg-ice hover:text-blue hover:pl-[1.8rem] transition-all">🔧 Tips &amp; Perawatan</Link>
                <Link to="/artikel#industri" className="px-[1.5rem] py-[0.6rem] text-[0.85rem] font-medium text-text flex items-center gap-[0.6rem] hover:bg-ice hover:text-blue hover:pl-[1.8rem] transition-all">🏭 Aplikasi Industri</Link>
